 ...
 * @property Blade               $blade                               The blade engine class
 * @property Paginator			 $paginator							  The pagination class in the system.
 */
class CI_Controller {
 ...
 * @property CI_Utf8             $utf8                                Provides support for UTF-8 environments
 * @property Blade               $blade                               The blade engine class
 * @property Paginator           $paginator							  The pagination class for the system
 */
class MX_Controller {
